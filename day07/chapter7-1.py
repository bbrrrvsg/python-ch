...
print(random.choice([10,20,5,40]))      # choice([리스트]) , 리스트내 램덤요소 1개 반환 
a = random.shuffle([1,2,3,4,5])
print(a)                                # shuffle([리스트]), 리스트내 료소들을 랜덤으로 섞는다.  , 원본이 수정된다 
print(random.sample([1,2,3,4,5], k=3))  #  # sample([리스트],k=개수) , 리스트내 k개 랜덤 요소 반환 
# k -2 : 키워드 매개변수 , k라는 이름 갖는 매개변수에 대입 